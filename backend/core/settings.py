...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'bestproducts'),
        'USER': os.environ.get('DB_USER', 'bestuser'),
...
# Django REST Framework — JWT as default authenticator
REST_FRAMEWORK = {
...
# Logging — capture auth failures and errors to file (OWASP A09)
LOGGING = {
    'version': 1,
